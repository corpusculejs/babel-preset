...
const buildImport = template('import _injectDecoratorInitializer from "@corpuscule/babel-preset/lib/runtime-injector";');
...
const babelPluginInjectDecoratorInitializer = () => ({
  ...
  visitor: {
    ...
    Class: {
      ...
      exit() {
        console.log(this.constructorFirstOriginalStatement);
      },
    },
    ClassBody: {
      exit(path) {
